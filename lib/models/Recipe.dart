...
class Recipe extends amplify_core.Model {
  ...
  Recipe copyWithModelFieldValues({
    ...
    ModelFieldValue<bool>? isFavorited,
    ...
    return Recipe._internal(
      ...
      isFavorited: isFavorited == null ? this.isFavorited : isFavorited.value,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'serve': _serve, 'duration': amplify_core.enumToString(_duration), 'category': amplify_core.enumToString(_category), 'description': _description, 'image': _image, 'isFavorited': _isFavorited, 'duration_unit': _duration_unit, 'ingredients': _ingredients, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final ISFAVORITED = amplify_core.QueryField(fieldName: "isFavorited");
